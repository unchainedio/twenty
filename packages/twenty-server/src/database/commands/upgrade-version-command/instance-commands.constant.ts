...
import { BackfillCreditBalanceIntoGrantsFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-31/2-31-instance-command-fast-1786368742016-backfill-credit-balance-into-grants';
...
export const INSTANCE_COMMANDS = [
  ...
  BackfillCreditBalanceIntoGrantsFastInstanceCommand,
];
